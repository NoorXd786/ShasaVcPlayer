...
from Shasa import ASSID, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Shasa import boottime as bot_start_time
from Shasa import db
...
from Shasa.Inline import (custommarkup, dashmarkup, setting_markup, setting_markup2,
