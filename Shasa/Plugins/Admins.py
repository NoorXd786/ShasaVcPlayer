...
from Shasa.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await Shasa.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await Shasa.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
