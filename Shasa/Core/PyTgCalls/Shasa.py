...
from Shasa import MUSIC_BOT_NAME, app, db_mem, userbot
...
from Shasa.Database import remove_active_chat
from Shasa.Inline import (audio_markup, audio_timer_markup_start,
