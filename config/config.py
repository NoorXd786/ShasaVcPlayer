...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", None)  # Example:- https://t.me/LionXupdates
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @LionXStringbot
