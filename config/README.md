...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@LionXStringbot](http://t.me/LionXStringbot) in Telegram.
...
- If you plan to use Shasa Music Bot with your own customized or modified code.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@LionXStringbot](http://t.me/LionXStringbot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@LionXStringbot](http://t.me/LionXStringbot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@LionXStringbot](http://t.me/LionXStringbot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@LionXStringbot](http://t.me/LionXStringbot) in Telegram.
